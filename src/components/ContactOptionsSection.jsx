    ...
    <ul className=" lg:w-2/5 w-3/4 p-2 flex flex-col gap-8">
      <li className=" flex gap-8 items-center">
        ...
        <div className=" flex flex-col gap-3">
          ...
          <p className=" text-sm text-gray-500">
            Estou disponível, me envie uma mensagem!
          </p>
          <a
            href="https://wa.me/5521985643871"
      ...
      <li className=" flex gap-8 items-center">
        ...
        <div className=" flex flex-col gap-3">
          ...
          <a
            href="mailto:alvaro.a.p.r.s@gmail.com"
      ...
      <li className=" flex gap-8 items-center">
        ...
        <div className=" flex flex-col gap-3">
          ...
          <p className=" text-sm text-gray-500">
            Meu linkedin, me adicione ou mande uma mensagem
          </p>
          <a
            href="https://www.linkedin.com/in/alvaro-paiva-dos-reis-s%C3%A1-a032991b5/"
            target="_blank"
            rel="noreferrer"
