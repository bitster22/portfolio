        ...
        <li className=" w-[30rem] flex flex-col gap-2 border-2 rounded-md p-4 border-gray-400">
            ...
            <div className=" flex gap-4">
                <div className=" flex text-purple-500 gap-2 items-center">
                    <FaGithub/>
                    <a href={project.github_link} className=" border-b border-[transparent] hover:border-white">Repositório</a>
                </div>
                {
                    project.vercel_link != "" ? 
                    <div className=" flex text-orange-400 gap-1 items-center">
                        <IoArrowRedoOutline/>
                        <a href={project.vercel_link} className="border-b border-[transparent] hover:border-white">Aplicação</a>
                    </div> : null
                }
            </div>
        </li>
